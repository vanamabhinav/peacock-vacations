        ...
        <div className="min-h-screen bg-[#fafbfc] flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-white rounded-[32px] shadow-xl overflow-hidden border border-gray-100 p-8 md:p-12">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-black text-[#1a3642] tracking-tighter">Welcome Back</h1>
                    <p className="text-gray-400 font-bold text-sm mt-2">Sign in to continue your adventure</p>
                </div>
                ...
                <p className="text-center mt-10 text-gray-500 font-bold text-sm">
                    ...
                    <Link href="/signup" className="text-[#f1aa4c] hover:underline">
                        Create one
                    </Link>
                </p>
            </div>
