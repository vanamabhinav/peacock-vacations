                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
                    ...
                    <div className="space-y-5">
                        <div className="flex flex-col gap-0.5">
                            ...
                            <p className="text-xl font-black text-[#345b63]">{itineraryData.stayDetails.type}</p>
                        </div>

                        <div className="flex items-center justify-between gap-4 py-1">
                            <div className="flex flex-col gap-0.5">
                                <p className="text-[11px] font-black text-[#1a3642]/50 uppercase tracking-widest leading-none">Start At</p>
                                <p className="text-base font-black text-[#1a3642]">{itineraryData.duration.startDate}</p>
                            </div>
                            ...
                            <div className="flex flex-col text-right gap-0.5" >
                                ...
                                <p className="text-base font-black text-[#1a3642]">{itineraryData.duration.endDate}</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-3">
                                {itineraryData.packageIncludes.map((item) => (
                        ...
                        <div className="pt-4 border-t border-gray-100 flex justify-between items-center">
                            ...
                            <p className="text-xl font-black text-[#1a3642]">₹{itineraryData.price.emiAmount} <span className="text-xs font-bold text-gray-400">/month</span></p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-[#fef9f3] border border-[#fef2e2] rounded-2xl p-5 flex flex-col gap-4">
                    <div>
                        ...
                        <div className="flex items-baseline gap-1">
                            <p className="text-3xl font-black text-[#1a3642]">₹ {itineraryData.price.discountedAmount.toLocaleString()}</p>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <a href={`tel:${itineraryData.contactPhone}`} className="flex items-center justify-center gap-2 text-[#1a3642] font-black text-lg hover:scale-105 transition-all">
                            <span className="text-xl">📞</span> {itineraryData.contactPhone}
                        </a>
