            ...
            <div className="p-5 md:p-6">
                <div className="flex flex-col md:flex-row justify-between font-bold items-start md:items-center gap-4 mb-6">
                    <div className="flex flex-col gap-1">
                        ...
                        <p className="text-[#345b63] text-xs md:text-sm font-bold opacity-70">{itineraryData.duration.startDate} → {itineraryData.duration.endDate}</p>
                    </div>
                                ...
                                <div className="w-full flex items-center gap-2">
                                    ...
                                    <div className="flex-1 border-t-2 border-dashed border-gray-200 relative">
                                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#fcfbfb] md:bg-white px-3">
                                            <p className="text-[10px] md:text-xs font-black text-[#1a3642] whitespace-nowrap">{flight.duration}</p>
                                        </div>
                                    </div>
                                    <span className="text-gray-300 text-sm scale-x-[-1]">✈</span>
                                </div>
                                <p className="text-[9px] md:text-[10px] font-black text-[#1a3642] mt-3 md:mt-4 opacity-60">{flight.stops} Stop</p>
                            </div>
